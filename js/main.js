...
function displayTimeLeft(seconds) {
  ...
  const display = `${minutes > 10 ? minutes : "0" + minutes} : ${
...
startBtn.addEventListener("click", function () {
  ...
  function randomJustDoItSounds() {
    const allFiles = [
      ...
      "do-it-1.wav",
      "do-it-2.wav",
      "dreams-be-dreams.wav",
      "nothing-is-impossible.wav",
      "yes-you-can.wav",
      "make-your-dreams.wav",
    ];
...
function muteSound() {
  ...
  soundOn
    ? (muteBtn.src = "./media/images/sound-on-icon.png")
    : (muteBtn.src = "./media/images/mute-icon.png");
}
...
let allBackgrounds = [
  "url('./media/images/bgs/ed.jpg')",
  "url('./media/images/bgs/haka.jpg')",
  "url('./media/images/bgs/cat.jpg')",
  "url('./media/images/bgs/mosh.jpg')",
  "url('./media/images/bgs/bodybuilders.jpg')",
  "url('./media/images/bgs/meerkats.jpg')",
  "url('./media/images/bgs/party.jpg')",
  "url('./media/images/bgs/wedding.jpg')",
  "url('./media/images/bgs/photogenic.jpg')",
  "url('./media/images/bgs/space.jpg')",
  "url('./media/images/bgs/bathroom.jpg')",
];
...
let allBackgroundsMob = [
  "url('./media/images/bgs-mob/ed.jpg')",
  "url('./media/images/bgs-mob/cat.jpg')",
  "url('./media/images/bgs-mob/eiffel.jpg')",
  "url('./media/images/bgs-mob/meerkats.jpg')",
  "url('./media/images/bgs-mob/space.jpg')",
];
